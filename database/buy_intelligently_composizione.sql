...
CREATE TABLE `composizione` (
  ...
  KEY `composizione_fk2_idx` (`id_prodotto`),
  CONSTRAINT `composizione_fk1` FOREIGN KEY (`id_ordine`) REFERENCES `ordine` (`id_ordine`) ON UPDATE CASCADE,
  CONSTRAINT `composizione_fk2` FOREIGN KEY (`id_prodotto`) REFERENCES `prodotto` (`id_prodotto`)
